	...
	return (
		<Layout>
			<div className="bg-zinc-900 p-6 w-[30vw] min-h-[54vh] rounded-md">
				...
				<form className="flex flex-col gap-6 mt-8" onSubmit={handleSubmit(onSumit)}>
					<ControllerTextInput 
						control={control}
						name="email"
						label="E-mail"
					...
					<ControllerTextInput 
						...
						rightIcon={
							!showPassword ? <Eye className="ml-2 text-white" size={24} /> : <EyeClosed className="ml-2 text-white" size={24} />
						}
					/>
