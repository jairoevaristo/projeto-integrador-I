			...
			<div className="bg-zinc-900 p-6 w-[30vw] min-h-[84vh] rounded-md">
				...
				<form className="flex flex-col gap-6 mt-8" onSubmit={handleSubmit(onSubmit)}>
					...
					<ControllerTextInput 
						...
						onClickRightIcon={() => {
							setShowPassword(prevState => ({...prevState, senha: !prevState.senha }))}
						}
						rightIcon={
							!showPassword.senha? <Eye className="ml-2 text-white" size={24} /> : <EyeClosed className="ml-2 text-white" size={24} />
						}
					/>
					...
					<ControllerTextInput 
						...
						placeholder="Digite sua senha"
						onClickRightIcon={() => {
							setShowPassword(prevState => ({...prevState, confirmar_senha: !prevState.confirmar_senha }))}
						}
						rightIcon={
							!showPassword.confirmar_senha? <Eye className="ml-2 text-white" size={24} /> : <EyeClosed className="ml-2 text-white" size={24} />
						}
					/>
